...
سلام! من **امیرعلی سرداری** هستم، برنامه‌نویس ارشد پایتون و عاشق دنیای متن‌باز.

- **گیت‌هاب**: [@amiralicoldark](https://github.com/amiralicoldark)
- **روبیکا**: [@AmiraliColdark](https://rubika.ir/AmiraliColdark)
- **ایمیل**: amiralicoldark@gmail.com
